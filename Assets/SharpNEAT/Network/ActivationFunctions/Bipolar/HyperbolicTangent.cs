...
namespace SharpNeat.Network
{
    ...
    public class HyperbolicTangent : IActivationFunction
    {
        ...
        /// </summary>
        public static readonly IActivationFunction __DefaultInstance = new HyperbolicTangent();
        ...
        {
            get { return "Hyperbolic tangent function with doubled period.\r\nEffective xrange->[-Inf,Inf] yrange[-1,1]"; }
        }       
