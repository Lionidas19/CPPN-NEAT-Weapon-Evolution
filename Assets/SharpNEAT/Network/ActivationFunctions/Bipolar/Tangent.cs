...
namespace SharpNeat.Network
{
    ...
    /// </summary>
    public class Tangent : IActivationFunction
    {
        /// <summary>
        /// Default instance provided as a public static field.
        /// </summary>
        public static readonly IActivationFunction __DefaultInstance = new Tangent();
        ...
        {
            get { return "Tangent function with doubled period.\r\nEffective xrange->[-Inf,Inf] yrange[-1,1]"; }
        }       
        ...
        {
            double result = (float)Math.Tan(x);
            if (result < 1.0 && result > -1.0) return result;
