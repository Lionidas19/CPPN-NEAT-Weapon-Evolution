...
namespace SharpNeat.Network
{
    ...
    public class DefaultActivationFunctionLibrary : IActivationFunctionLibrary
    {
        ...
        {
            double probability = 1.0 / 7.0;
            List<ActivationFunctionInfo> fnList = new List<ActivationFunctionInfo>(7);
            fnList.Add(new ActivationFunctionInfo(0, probability, Sine.__DefaultInstance));
            fnList.Add(new ActivationFunctionInfo(1, probability, Cosine.__DefaultInstance));
            fnList.Add(new ActivationFunctionInfo(2, probability, Tangent.__DefaultInstance));
            fnList.Add(new ActivationFunctionInfo(3, probability, HyperbolicTangent.__DefaultInstance));
            fnList.Add(new ActivationFunctionInfo(4, probability, BipolarSigmoid.__DefaultInstance));
            fnList.Add(new ActivationFunctionInfo(5, probability, StepFunction.__DefaultInstance));
            fnList.Add(new ActivationFunctionInfo(6, probability, RampFunction.__DefaultInstance));
            return new DefaultActivationFunctionLibrary(fnList);
        }
        ...
        /*Sine
         ...
         Step
         Gaussian*/
        public static IActivationFunctionLibrary CreateLibraryCppn(int lib)
        {
            List<ActivationFunctionInfo> fnList;
            if (lib == 0)
            {
                fnList = new List<ActivationFunctionInfo>(2);
                fnList.Add(new ActivationFunctionInfo(0, 0.5, Sine.__DefaultInstance));
                fnList.Add(new ActivationFunctionInfo(1, 0.5, Cosine.__DefaultInstance));
            }
            else if(lib == 1)
            {
                fnList = new List<ActivationFunctionInfo>(1);
                fnList.Add(new ActivationFunctionInfo(0, 1, Tangent.__DefaultInstance));
                fnList.Add(new ActivationFunctionInfo(0, 0.5, Sine.__DefaultInstance));
                fnList.Add(new ActivationFunctionInfo(1, 0.5, Cosine.__DefaultInstance));
            }
            else
            {
                fnList = new List<ActivationFunctionInfo>(3);
                fnList.Add(new ActivationFunctionInfo(0, 0.34, StepFunction.__DefaultInstance));
                fnList.Add(new ActivationFunctionInfo(1, 0.33, Sine.__DefaultInstance));
                fnList.Add(new ActivationFunctionInfo(2, 0.33, Cosine.__DefaultInstance));
            }
            return new DefaultActivationFunctionLibrary(fnList);
        }
