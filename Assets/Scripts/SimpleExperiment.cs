...
public class SimpleExperiment : INeatExperiment
{
    ...
    {
        return new /*NeatGenomeFactory*/ CppnGenomeFactory(InputCount, OutputCount, DefaultActivationFunctionLibrary.CreateLibraryCppn(), _neatGenomeParams);
    }
